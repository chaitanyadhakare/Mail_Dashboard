...
namespace MVCHackathon.Areas.Dashboard.Services
{
    public class DashboardService
    {
        ...
        public long GetOutgoingToInternalCount(string type, string source, UserSession UISssn)
        {
            long count = 0;
            ...
            try
            {
                ...
                if (source == "customer")
                {
                    sbsql.Append(" and SenderId =  ");
                    sbsql.Append(UISssn.LoggedInUserId);
                }
                sbsql.Append(" ; ");
        ...
        public long GetOutgoingToExternalCount(string type, string source, UserSession UISssn)
        {
            long count = 0;
            Object oModel = new DashboardModel();
            DbDataReader reader = null;
        ...
        public long GetIncomingFromInternalCount(string type, string source, UserSession UISssn)
        {
            long count = 0;
            Object oModel = new DashboardModel();
            MySqlConnection connection = new MySqlConnection(UISssn.ConnectionString);
        ...
        public long GetIncomingFromExternalCount(string type, string source, UserSession UISssn)
        {
            long count = 0;
            Object oModel = new DashboardModel();
            MySqlConnection connection = new MySqlConnection(UISssn.ConnectionString);
        ...
        public List<DashboardModel> GetOutgoingInternalTop10IdsList(string type, string operation, UserSession UISssn)
        {
            List<DashboardModel> SelectedList = new List<DashboardModel>();
            Object list = new List<DashboardModel>();
            Object listitem = new DashboardModel();
            ...
            try
            {
                ...
                if (type == "daily")
                {
                    ...
                    sbsql.Clear();
                    sbsql.Append(" select Count(a.MailId) as Count, a." + operationMode + " from mailbox as a ");
                    sbsql.Append(" inner join  statistics as b on a.MailId = b.MailId ");
                    sbsql.Append(" where date_format(a.InsertTimeStamp, '" + tempVar + "') = date_format(now(), '" + tempVar + "') ");
                    sbsql.Append(" and b.IsInternal=1 ");
        ...
        public List<DashboardModel> GetOutgoingExternalTop10IdsList(string type, string operation, UserSession UISssn)
        {
            List<DashboardModel> SelectedList = new List<DashboardModel>();
            Object list = new List<DashboardModel>();
            Object listitem = new DashboardModel();
        ...
        public List<DashboardModel> GetIncomingInternalTop10IdsList(string type, string operation, UserSession UISssn)
        {
            List<DashboardModel> SelectedList = new List<DashboardModel>();
            Object list = new List<DashboardModel>();
            Object listitem = new DashboardModel();
        ...
        public List<DashboardModel> GetIncomingExternalTop10IdsList(string type, string operation, UserSession UISssn)
        {
            List<DashboardModel> SelectedList = new List<DashboardModel>();
            Object list = new List<DashboardModel>();
            Object listitem = new DashboardModel();
